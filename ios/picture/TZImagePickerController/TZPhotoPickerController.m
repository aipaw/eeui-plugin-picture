...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItems = [UINavigationConfig itemSpace:[[UIBarButtonItem alloc] initWithTitle:tzImagePickerVc.cancelBtnTitleStr style:UIBarButtonItemStylePlain target:tzImagePickerVc action:@selector(cancelButtonClick)]];
